...
Run `python3 state-supervision/supervise.py --help` from the repository root.
The Web service is started with `python3 state-supervision/serve.py`.
...
`BUNDLE_MANIFEST.json` and `VERSION` identify the exact portable build. The
installer includes the public Skill, backend, Human UI, tests and evaluation
tools; it excludes generated runtime state and earlier test results.
...
Operators should start with [OPERATOR_GUIDE.md](OPERATOR_GUIDE.md). Internal
...
[`../state-supervision-evaluation/PRODUCT_ROADMAP.md`](../state-supervision-evaluation/PRODUCT_ROADMAP.md)
and
[`../state-supervision-evaluation/PRODUCT_BACKLOG.md`](../state-supervision-evaluation/PRODUCT_BACKLOG.md).
