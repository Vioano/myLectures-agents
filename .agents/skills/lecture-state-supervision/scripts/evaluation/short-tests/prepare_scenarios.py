...
OPERATOR_GUIDE = SKILL_ROOT / "references" / "operator-guide.md"
...
def make_workspace(root: Path, scenario: str, mission: str) -> tuple[Path, Path, SupervisionService]:
    ...
    environment = {
        ...
        "operator_guide": str(OPERATOR_GUIDE.resolve()),
...
Use only the bound public operator guide, this mission, and the public
