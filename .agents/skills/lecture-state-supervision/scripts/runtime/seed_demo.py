...
def main() -> int:
    ...
    if any(item["episode_id"] == episode_id for item in service.data_root.list_episodes()):
        ...
        return 0
    guidance = str(FIXTURE_ROOT / "guidance.md")
    expect(
    ...
    expect(
        service.submit(
            ...
            "T001",
            actor="Ada",
            artifacts=[{"role": "contract", "path": str(FIXTURE_ROOT / "episode-contract.txt")}],
    ...
    expect(
        service.submit(
            ...
            "T020",
            actor="Cai",
            artifacts=[{"role": "storyboard", "path": str(FIXTURE_ROOT / "storyboard.md")}],
    ...
    expect(
        service.submit(
            ...
            "T030",
            actor="Dai",
            artifacts=[{"role": "source", "path": str(FIXTURE_ROOT / "animation.py")}],
    ...
    expect(
        service.submit(
            ...
            "T060",
            actor="Fang",
            artifacts=[{"role": "release_note", "path": str(FIXTURE_ROOT / "release-note.md")}],
